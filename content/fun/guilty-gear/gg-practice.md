...
<ul id="section-intermediate" class="practice-list">
  <li>
    <details>
      ...
      <ul>
        <li>「起き上がり」、および「壁割り後」に詐欺飛びを重ねる練習。無敵必殺技をガードできたら、溜めダストからのコンボ、あるいは {{< gg "c.S" >}} からのフルコン。
        <ul>
          <li>トレーニング設定 → 反撃設定 → 起き上がり後の反撃「ランダム」
          <ul>
            <li>カイ:「ヴェイパースラスト」「立ちP」
  ...
  <li>
    <details>
      <summary>シミーからの最大ダメージ練習</summary>
      <ul>
        <li>トレーニング設定 → 反撃設定 → 起き上がり後の反撃「ランダム」
        <ol>
          <li>投げ（空振り） → {{< gg "dash c.S ..." >}} で反撃
          <li>ジャンプ → {{< gg "空投げ RRC ..." >}} で反撃
          <li>無敵昇竜 → {{< gg "dash c.S ..." >}} で反撃
        </ol>
  ...
  <li>
    <details>
      ...
      <ul>
        <li>相手のジャンプ攻撃がめくりかどうか微妙なとき
        <ul>
          <li>FD しながら {{< gg "4P" >}} 連打 ... めくりの場合のみ {{< gg "6P" >}} が出る。
        </ul>
        <li>地上で裏まわり攻撃されそうなとき
        <ul>
          <li>FD しながら {{< gg "4D" >}} 連打 ... 背後に回られた場合のみ投げが出る。
        </ul>
        <li>通常技を重ねた瞬間に覚醒必殺技を出されたとき
        <ul>
          <li>ダメ元で FD を張る ... 通常技の出始め数フレーム以内なら FD キャンセルでガードできる可能性がある。
        </ul>
        <li>空中ダッシュの終わりぎわのブレーキをなくす空中 FD
        <ul>
          <li>空中ダッシュ → {{< gg "6" >}} 入れながら {{< gg "K → FD" >}} をほぼ同時に一瞬入力すると、空中攻撃をキャンセルする FD が一瞬出て、空中ダッシュ後のブレーキがかからなくなる。結果的に着地位置が若干前になり、着地までの時間も短くなる。これですぐに着地して投げにいったりできる。
        </ul>
      </ul>
    </details>
  </li>
...
- **中距離では対空を意識** ... 何もないところからのジャンプ攻撃は絶対に咎める。
- **近距離での最速行動** ... 近距離の行動勝負では {{< gg "c.S" >}} を狙わず {{< gg "5P" >}} or {{< gg "2P" >}} で我慢。慣れたら {{< gg "RCC" >}} へ。
