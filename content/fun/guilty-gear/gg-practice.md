...
シミー／投げ釣り
: 投げるよーと見せかけて、ちょっと後退することで相手の投げを空かす動き。
たまにはバックステップしてみるのも面白い。
  ...
  <li>
    <details>
      ...
      <ul>
        ...
        <li>ジャンプは先行入力気味に入力すると {{< gg "j.D" >}} になるミスが出にくい。
          あとは、飛んだ瞬間に {{< gg "D" >}} 目押し入力すれば超低空で投げられる。
        <li>起き上がりをシミーして、相手のファジージャンプを投げで捕まえるのが主な使い方になりそうだけど、ファジージャンプは上級者しか使ってこないかも。
        <li>最初をダッシュジャンプにすればより遠くから投げられるが使い道は限定的。
        <li>空中ダッシュからも投げられるので、相手の空中ダッシュとぶつかりそうなときに空投げに行くのもあり。
        <li>カイの起き上がりヴェイパースラストを空投げしまくる練習をするとよい（実戦では溜めダストなどを入れるけど）。
          トレーニング設定 → 反撃設定 → 起き上がり後の反撃「ヴェイパースラスト」を設定して空投げの入力タイミングに慣れる。
      </ul>
    </details>
  </li>
  <li>
...
<ul id="section-intermediate" class="practice-list">
  ...
  <li>
    <details>
      <summary>空対空投げ</summary>
      <ul>
        <li>相手が空中ダッシュで攻めてくることが読めたら、前ジャンプ＆投げで迎撃してみる。
      </ul>
    </details>
  </li>
  <li>
    <details>
      ...
      <ul>
        ...
        <ul>
          <li>レバーレス入力: ●●◯+FD → ●◯◯+投げ → ●●◯+FD
          <li>相殺できずに投げられるようであれば、{{< gg "●●◯+投げ" >}} 入力になっていたり、{{< gg "FD" >}} を離せていない可能性がある。確実に {{< gg "●◯◯+投げ" >}} のみで入力すること。
        </ul>
      </ul>
    </details>
  </li>
